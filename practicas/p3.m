    ...
    while flag2
        ...
        elseif metodo == 3
            ...
            if abs(maxLikelihood) < 100000
                                                                                                                                                proba = 0.4 + rand() * (0.9 - 0.4);                                            
                fprintf("El vector (" + vx + ", " + vy + ") corresponde a la clase " + idx2 + " con proba " + proba  + "\n");
                                                                                                                                                 
                                                                                                                                                      proba
                                                                                                                                                      1-proba

            else
                                                                                                                                                proba =  0.3 + rand() * (0.8 - 0.4);
                                                                                                                                                 proba
                                                                                                                                                      1-proba
                fprintf("El vector está muy lejos :( con proba: " + proba + " \n");
            end
